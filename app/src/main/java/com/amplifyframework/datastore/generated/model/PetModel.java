...
/** This is an auto generated class representing the PetModel type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "PetModels", authRules = {
  @AuthRule(allow = AuthStrategy.PUBLIC, operations = { ModelOperation.CREATE, ModelOperation.UPDATE, ModelOperation.DELETE, ModelOperation.READ })
})
public final class PetModel implements Model {
  public static final QueryField ID = field("PetModel", "id");
  public static final QueryField NAME = field("PetModel", "name");
  public static final QueryField OWNER_NAME = field("PetModel", "ownerName");
  public static final QueryField EMAIL = field("PetModel", "email");
  public static final QueryField AGE = field("PetModel", "age");
  public static final QueryField KIND = field("PetModel", "kind");
  public static final QueryField BREED = field("PetModel", "breed");
  public static final QueryField PHONE = field("PetModel", "phone");
  public static final QueryField PLACE = field("PetModel", "place");
  public static final QueryField INFO = field("PetModel", "info");
  public static final QueryField SEX = field("PetModel", "sex");
  public static final QueryField IMAGE = field("PetModel", "image");
  ...
  private PetModel(String id, String name, String ownerName, String email, Integer age, String kind, String breed, String phone, String place, String info, String sex, String image) {
    this.id = id;
    this.name = name;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), petModel.getId()) &&
              ObjectsCompat.equals(getName(), petModel.getName()) &&
              ObjectsCompat.equals(getOwnerName(), petModel.getOwnerName()) &&
              ObjectsCompat.equals(getEmail(), petModel.getEmail()) &&
              ObjectsCompat.equals(getAge(), petModel.getAge()) &&
              ObjectsCompat.equals(getKind(), petModel.getKind()) &&
              ObjectsCompat.equals(getBreed(), petModel.getBreed()) &&
              ObjectsCompat.equals(getPhone(), petModel.getPhone()) &&
              ObjectsCompat.equals(getPlace(), petModel.getPlace()) &&
              ObjectsCompat.equals(getInfo(), petModel.getInfo()) &&
              ObjectsCompat.equals(getSex(), petModel.getSex()) &&
              ObjectsCompat.equals(getImage(), petModel.getImage()) &&
              ObjectsCompat.equals(getCreatedAt(), petModel.getCreatedAt()) &&
              ObjectsCompat.equals(getUpdatedAt(), petModel.getUpdatedAt());
      }
  }
   ...
   */
  public static PetModel justId(String id) {
    return new PetModel(
      id,
      null,
      null,
